...
export default function Home() {
  ...
  return (
    <div className="space-y-8">
      <section className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-2xl text-white p-8">
        <h1 className="text-3xl font-bold">Recipe Price Calculator</h1>
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          ...
          <Link
            href="/recipes"
            className="px-4 py-2 rounded-md bg-indigo-500/40 border border-white/40 text-white font-medium hover:bg-indigo-500/60"
          >
            View recipes
          </Link>
        </div>
